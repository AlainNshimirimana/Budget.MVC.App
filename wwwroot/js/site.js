...
$("#updateTransaction").on("click", function () {
    ...
    $(`#insert-transaction-form #InsertTransaction_CategoryId option[value=${categoryId}]`)
        .attr('selected', 'selected');
    $('#insert-transaction-form #InsertTransaction_TransactionType').find(`option:contains('${$.trim(transactionType)}')`)
        .attr('selected', 'selected');
    $("#addTransactionModal").modal("show");
});
